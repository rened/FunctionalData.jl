...
@inline setat!(a::AbstractArray{T,2},i::Number,v::AbstractArray) where {T} = (a[:,i] = v; a)
@inline setat!(a::AbstractArray{T,3},i::Number,v::AbstractArray) where {T} = (a[:,:,i] = v; a)
@inline setat!(a::AbstractArray{T,4},i::Number,v::AbstractArray) where {T} = (a[:,:,:,i] = v; a)
@inline setat!(a::AbstractArray{T,5},i::Number,v::AbstractArray) where {T} = (a[:,:,:,:,i] = v; a)
@inline setat!(a::AbstractArray{T,6},i::Number,v::AbstractArray) where {T} = (a[:,:,:,:,:,i] = v; a)
@inline setat!(a::AbstractArray{T,7},i::Number,v::AbstractArray) where {T} = (a[:,:,:,:,:,:,i] = v; a)
@inline setat!(a::AbstractArray{T,8},i::Number,v::AbstractArray) where {T} = (a[:,:,:,:,:,:,:,i] = v; a)
